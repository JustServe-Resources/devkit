...
public interface GraphQLClient {
    ...
    @Post
    Mono<GraphQLResponse<ProjectEvent>> createEvent(@Body CreateEventMutation request);

    @Post
    Mono<GraphQLResponse<CreateEventsData>> createEvents(@Body CreateEventsMutation request);

    @Post
    Mono<GraphQLResponse<CreateRecurringEventsData>> createRecurringEvents(@Body CreateRecurringEventsMutation request);

    @Post
    Mono<GraphQLResponse<GraphQLAddProjectAttachmentData>> executeAddProjectAttachment(@Body GraphQLAddProjectAttachmentRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLAddProjectOrganizationData>> executeAddProjectOrganization(@Body GraphQLAddProjectOrganizationRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLCombinedMutationUpdateProjectAddProjectTagData>> executeCombinedMutationUpdateProjectAddProjectTag(@Body GraphQLCombinedMutationUpdateProjectAddProjectTagRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLCreateProjectData>> executeCreateProject(@Body GraphQLCreateProjectRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLPublishProjectData>> executePublishProject(@Body GraphQLPublishProjectRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLSearchOrganizationData>> executeSearchOrganization(@Body GraphQLSearchOrganizationRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLSetProjectLocationData>> executeSetProjectLocation(@Body GraphQLSetProjectLocationRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLUpdateProjectAttachmentData>> executeUpdateProjectAttachment(@Body GraphQLUpdateProjectAttachmentRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLUpdateProjectListingData>> executeUpdateProjectListing(@Body GraphQLUpdateProjectListingRequest request);

    @Post
    Mono<GraphQLResponse<GraphQLUpdateProjectData>> executeUpdateProject(@Body GraphQLUpdateProjectRequest request);

    default Mono<GraphQLResponse<GraphQLAddProjectAttachmentData>> addProjectAttachment(GraphQLAddProjectAttachmentVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLAddProjectOrganizationData>> addProjectOrganization(GraphQLAddProjectOrganizationVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLCombinedMutationUpdateProjectAddProjectTagData>> combinedMutationUpdateProjectAddProjectTag(GraphQLCombinedMutationUpdateProjectAddProjectTagVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLCreateProjectData>> createProject(GraphQLCreateProjectVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLPublishProjectData>> publishProject(GraphQLPublishProjectVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLSearchOrganizationData>> searchOrganization(GraphQLSearchOrganizationVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLSetProjectLocationData>> setProjectLocation(GraphQLSetProjectLocationVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLUpdateProjectAttachmentData>> updateProjectAttachment(GraphQLUpdateProjectAttachmentVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLUpdateProjectListingData>> updateProjectListing(GraphQLUpdateProjectListingVariables variables) {
    ...
    default Mono<GraphQLResponse<GraphQLUpdateProjectData>> updateProject(GraphQLUpdateProjectVariables variables) {
