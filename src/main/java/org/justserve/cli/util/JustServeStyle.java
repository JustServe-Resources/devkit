 ...
 */
public final class JustServeStyle {

    public final static Ansi blue = ansi().fgRgb(0, 158, 185);
    public final static Ansi orange = ansi().fgRgb(255, 140, 0); // OG color is 239, 94, 57
    public final static Ansi red = ansi().fgRgb(233, 59, 84); // I definitely eyeballed this one
    public final static Ansi yellow = ansi().fgRgb(225, 188, 33);

    public final static Ansi normalStyle = ansi().reset();
    public final static Ansi titleStyle = blue.bold();
    public final static Ansi emphasisStyle = orange.bold();
    public final static Ansi warningStyle = yellow;
    public final static Ansi errorTitleStyle = red.bold();
    public final static Ansi errorInfoStyle = ansi().reset();


    /**
     * Private constructor to prevent instantiation of this utility class.
     */
    private JustServeStyle() {
        throw new UnsupportedOperationException("This is a utility class and cannot be instantiated");
    }

    public static String applyStyle(String message, Ansi... style) {
